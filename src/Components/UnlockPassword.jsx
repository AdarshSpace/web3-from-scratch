    ...
    return (
        <div>
            <div className='border-1 border-gray-300/20 rounded-xl bg-gray-500/40 p-10'>
                ...
                <div className=' mb-10'>
                    <h1 className='flex justify-center text-white font-bold text-3xl '>Unlock Password</h1>
                ...
                <div className='mb-5 relative'>
                    ...
                    <input type={showPassword ? 'text' : 'password'} className='border-1 text-white w-full px-5 py-3 mt-2 rounded-2xl' placeholder='Enter Strong Password' />
                ...
                <div className='mb-5'>
                    ...
                    <input type="password" className='border-1 rounded-2xl text-white w-full px-5 py-3 mt-2' placeholder='Re-enter your password' />
                </div>

                <div className='flex gap-5'>
                    <button className='font-bold text-white text-xl border-1 rounded-xl py-2 px-10 my-2'> ← Back</button>
                    <button className='font-bold text-white text-xl border-1 rounded-xl py-2 px-5 my-2'>Create wallet</button>
                </div>
            </div>
        </div>
    )
